<h2><a href="https://www.geeksforgeeks.org/problems/largest-element-in-array4009/1?page=2&category=Arrays&sortBy=submissions">Largest Element in Array</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an array <strong>arr</strong><strong>, </strong>the task is to find the largest element in it.</span><br><span style="font-size: 18px;"><strong>Examples:</strong></span></p>
